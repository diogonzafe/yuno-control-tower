...
export type RollupRow = { bucket: string; merchantId: string; providerId: string; country: "BR" | "MX" | "AR"; paymentMethod: "CARD" | "PIX"; issuerId: string; attempts: number; approved: number; amountMinorSum: number; amountUsdSum: number; approvedUsdSum: number };
